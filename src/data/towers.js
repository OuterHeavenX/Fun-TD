export const TOWERS={
 bolt:{name:'Bolt Bastion',role:'Rapid single target',cost:110,color:'#5cc8ff',range:154,damage:14,rate:4.1,projectile:520,branches:['Armor Piercing','Rapid Volley']},
 ...
 frost:{name:'Frost Relay',role:'Slow and control',cost:135,color:'#8ff6ff',range:142,damage:7,rate:1.7,projectile:390,branches:['Deep Freeze','Wide Field']},
